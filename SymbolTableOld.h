...
public:
    ...
    void setArrayType(MPLType vartype);
private:
    MPLType type;
    MPLType array_type;
};
...
public:
    ...
    // if the variable is already of another type.
    void storeVector(std::string name,MPLType vector_type);
    ...
    //returns the type of the pieces inside of the array
    MPLType getSymbolTypeArray(std::string name);
private:
